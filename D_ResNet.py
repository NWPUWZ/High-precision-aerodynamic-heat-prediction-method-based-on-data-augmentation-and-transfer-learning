...
"""Model continuation"""
model=torch.load('./model_UTmulti/model.pth')
"""Model part of the neural network layer frozen"""
model.net2.linear_input.weight.requires_grad=False
model.net2.linear_input.bias.requires_grad=False
for i in np.arange(0,4,1):
    model.net2.linear_layers[i].weight.requires_grad=False
    model.net2.linear_layers[i].bias.requires_grad=False
"""Model re-training"""
